...
<p2> T3xM3u6w_b:   this is p2 _1100_ q2enK/vL T3xM3u6w_e
<p1> T3xM3u6w_b:   hello this is 3rd msg from p1 _3100_ n6lh47Xw T3xM3u6w_e
<p4> T3xM3u6w_b:   msg from p4 _0001_ tS86sjtS T3xM3u6w_e
<p3> T3xM3u6w_b:   greetings from p3 _2111_ Rm+KVVL4 T3xM3u6w_e
'''.splitlines()
    ,
...
#
# tx at 3, rx at (4, -, 6, 4)
send T3xM3u6w_b:   this is p2 _1100_ q2enK/vL T3xM3u6w_e
#
wait 20
...
send T3xM3u6w_b:   greetings from p3 _2111_ Rm+KVVL4 T3xM3u6w_e
#
wait 10
...
wait 7
#
# tx at 7, rx at (15, 8, 10, -)
send T3xM3u6w_b:   msg from p4 _0001_ tS86sjtS T3xM3u6w_e
#
wait 14
'''
...
delaydropspecs = {
    ...
    'p2':
    '|'.join(['T3xM3u6w_b:   this is p2 _1100_ q2enK/vL T3xM3u6w_e',
              '1000000', '0', '3000000', '1000000']) + '\n'
    ,

    'p3':
    '|'.join(['T3xM3u6w_b:   greetings from p3 _2111_ Rm+KVVL4 T3xM3u6w_e',
              '3000000', '3000000', '0', '1000000']) + '\n'
    ,

    'p4':
    '|'.join(['T3xM3u6w_b:   msg from p4 _0001_ tS86sjtS T3xM3u6w_e',
              '8000000', '1000000', '3000000', '0']) + '\n'
    ,
    }
